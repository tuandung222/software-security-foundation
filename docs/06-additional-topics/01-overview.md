...
sidebar_position: 1
description: Giới thiệu 4 chủ đề bổ sung mở rộng kiến thức Software Security ra ngoài 5 cụm chính.
---

# Lecture 7: Topics Bổ sung

> **Tóm tắt một dòng**: Cụm này gồm 4 bài độc lập, bổ sung kiến thức quan trọng mà không nằm trong scope chính của Lec 1-6. Bạn có thể đọc theo nhu cầu, không cần tuần tự.
