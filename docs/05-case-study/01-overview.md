...
> **Tóm tắt một dòng**: Phần này khác bốn phần trước về tinh thần: thay vì đi sâu vào một kỹ thuật, ta áp dụng tổng hợp mọi kỹ thuật đã học để **tư vấn** cho một dự án thực tế. Mỗi scenario có format: bối cảnh công ty, các vấn đề security cần quan tâm, recommendation cụ thể kèm trade-off.

## Vì sao cần phần Case Study?

Bốn phần trước (Lec 1-5) dạy kỹ thuật: CIA, vulnerabilities, BMC, SMT, fuzzing. Đó là **what** và **how**: cái gì là bug, làm sao tìm, làm sao chứng minh.

Phần này dạy **when** và **why**: trong một dự án cụ thể, ưu tiên gì, đầu tư vào đâu, đánh đổi như thế nào. Đây là kỹ năng của **security architect** hoặc **CISO**, không phải chỉ developer.
...
Phần này có 4 bài tương ứng 4 domain:
...
- Phần Case Study về **tư vấn** dự án thực, không phải kỹ thuật cụ thể.
