...
title: 8.2 Code patterns Phần 1 (Lec 1-2)
sidebar_position: 2
description: "Phân tích chi tiết các đoạn code C/C++ trong phần 1 về vulnerabilities: buffer overflow, NULL pointer, double free, integer overflow, format string, race condition."
---

# 8.2 Code patterns Phần 1 (Lec 1-2)

> **Tóm tắt một dòng**: Phần 1 giới thiệu vocabulary Software Security và liệt kê các lớp lỗ hổng implementation phổ biến. Mỗi lớp có 1-2 code sample minh hoạ. Bài này lấy từng sample đọc lại, comment chi tiết, giải thích state khi crash, và viết lại an toàn.
...
**Tiếp theo**: [8.3 Code patterns Phần 2 (BMC encoding)](./03-code-patterns-cluster-2)
