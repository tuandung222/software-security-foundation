...
sidebar_position: 3
description: Danh sách điểm kiến thức cần nắm vững sau mỗi cụm bài giảng.
---

# Checklist tự kiểm tra

Sau khi đọc xong mỗi cụm bài giảng, hãy quay lại trang này và tự đánh dấu xem bạn đã nắm vững các điểm dưới đây chưa.

## Sau Cụm 1 (Lecture 1-2)

- [ ] Phát biểu CIA Triad và cho ví dụ vi phạm mỗi thuộc tính.
- [ ] Phân biệt Safety và Security trong một câu kèm ví dụ minh hoạ.
- [ ] Giải thích vì sao Cryptography không đủ để bảo đảm Software Security.
- [ ] So sánh Implementation Vulnerability và Design Vulnerability.
- [ ] Mô tả cơ chế buffer overflow trên stack với layout cụ thể.
...
:::info Sẽ cập nhật khi cụm Lecture 3 chi tiết hoàn thành.
:::

## Sau Cụm 3 (Lecture 4)

:::info Sẽ cập nhật khi cụm Lecture 4 chi tiết hoàn thành.
:::

## Sau Cụm 4 (Lecture 5)

:::info Sẽ cập nhật khi cụm Lecture 5 chi tiết hoàn thành.
:::
