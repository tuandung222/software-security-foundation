...
# 1.6 Bounded Model Checking và SMT basics
...
Cách "ngây thơ" là chạy chương trình với mọi input có thể, xem có input nào vi phạm không. Đã thấy ở bài 1.5, cách này bất khả thi vì input space khổng lồ.
...
```mermaid
flowchart LR
    A[1.6: BMC + SMT basics] --> B[Lecture 3: Static Analysis I]
    B --> C[3.4: SAT + DPLL]
